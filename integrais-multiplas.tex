...
\begin{document}
	...
	\begin{equation*}
		S = -\int_{0}^{\frac{\pi}{6}} \left[ x \cos (x+y) \right]_{y=0}^{\frac{\pi}{3}} dx
	\end{equation*}
	
	\begin{equation*}
		S = -\int_{0}^{\frac{\pi}{6}} \left( x \cos \left( x+\frac{\pi}{3} \right) - x \cos x \right) dx
	\end{equation*}
	
	\begin{equation*}
		S = -\int_{0}^{\frac{\pi}{6}} x \cos \left( x+\frac{\pi}{3} \right) dx + \int_{0}^{\frac{\pi}{6}} x \cos x dx
	\end{equation*}
	
	\begin{equation*}
		S = \left( \left[ -x \sin \left( x + \frac{\pi}{3} \right) \right]_{0}^{\frac{\pi}{6}} +\int_{0}^{\frac{pi}{6}} \sen \left( x + \frac{\pi}{3} \right) \right) dx
		- \left( \left[ -x \sen x \right]_{0}^{\frac{\pi}{6}} + \int_{0}^{\frac{\pi}{6}} \sen x \right)
	\end{equation*}
